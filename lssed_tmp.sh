...
#GIT_PATH=/home/$USER_TMP_HOME/git/LandSupport
...
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/landsupport.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatchmeta.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatch.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/disquery.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatch_5.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatch_5_3035.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatch_gs_5.php
#sed -i 's/\/var\/www\/html\/$APACHE_ROOT_PATH/\/var\/www\/html\/$APACHE_TMP_PATH/g' $GUI_PATH/plugins/landsupport/dispatch_gl.php
sed -i 's/\/var\/www\/html\/root/\/var\/www\/html\/tmp/g' $GUI_PATH/plugins/landsupport/landsupport.php
sed -i 's/\/var\/www\/html\/root/\/var\/www\/html\/tmp/g' $GUI_PATH/plugins/landsupport/dispatchmeta.php
sed -i 's/\/var\/www\/html\/root/\/var\/www\/html\/tmp/g' $GUI_PATH/plugins/landsupport/dispatch.php
sed -i 's/\/var\/www\/html\/root/\/var\/www\/html\/tmp/g' $GUI_PATH/plugins/landsupport/disquery.php
sed -i 's/\/var\/www\/html\/root/\/var\/www\/html\/tmp/g' $GUI_PATH/plugins/landsupport/dispatch_5.php
...
#sed -i 's/\/home\/$USER_PROD_HOME/\/home\/$USER_TMP_HOME/g' $GUI_PATH/plugins/landsupport/dispatchmeta.php
...
#sed -i 's/$USER_PROD_HOME\@192\.168\.$IP_DEV\.11/$USER_TMP_HOME\@192\.168\.$IP_PROD\.11/g' $GUI_PATH/plugins/landsupport/ras_coverage.php
#sed -i 's/$USER_PROD_HOME\@192\.168\.$IP_DEV\.11/$USER_TMP_HOME\@192\.168\.$IP_PROD\.11/g' $GUI_PATH/plugins/landsupport/dispatch_gl.php
#sed -i 's/$USER_PROD_HOME\@192\.168\.$IP_DEV\.11/$USER_TMP_HOME\@192\.168\.$IP_PROD\.11/g' $GUI_PATH/plugins/landsupport/dispatchgen.php
#sed -i 's/$USER_PROD_HOME\@192\.168\.$IP_DEV\.11/$USER_TMP_HOME\@192\.168\.$IP_PROD\.11/g' $GUI_PATH/plugins/landsupport/dispatchmeta.php
#sed -i 's/$USER_PROD_HOME\@192\.168\.$IP_DEV\.11/$USER_TMP_HOME\@192\.168\.$IP_PROD\.11/g' $GUI_PATH/plugins/landsupport/dispatchlib.php

# (6) main web application URL
# grep -inR "tmp.landsupport.eu" --include \*.php ~/git/LandSupport/gui/landsupportgui/plugins/
sed -i 's/app.landsupport.eu/tmp.landsupport.eu/g' $GUI_PATH/plugins/landsupport/landsupport.php
sed -i 's/app.landsupport.eu/tmp.landsupport.eu/g' $GUI_PATH/plugins/join/join.php
sed -i 's/app.landsupport.eu/tmp.landsupport.eu/g' $GUI_PATH/plugins/join/passwordreset.php
